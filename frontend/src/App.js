...
const AppContents = () => {
    ...
    const hideSidebar = location.pathname === "/signin" || location.pathname === "/signup" || location.pathname === "/fitnesssurvey" || location.pathname === "/" || location.pathname === "/dashboard";
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className={`flex-grow p-4 ${!hideSidebar ? 'mb-16' : ''}`}>
                <Routes>
                    ...
                    <Route path="/daily-workouts/:userId/:day" element={<DailyWorkoutList />} />
